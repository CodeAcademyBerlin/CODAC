...
const SingleChat = (props: Props) => {
  ...
  return (
    <div>
      <h1>Welcome to {conversations?Chatrooms?chatroom.data?.attributes.name}</h1>

      <div className="chat-container">
        <div className="chat-dashboard-container">
          <div className="pinned-conversations-container">
            <span className="conversations-container-title">
              Pinned Conversations of <strong>{conversations?.chatroom.data?.attributes.name}</strong>
            </span>
            {chatRooms &&
