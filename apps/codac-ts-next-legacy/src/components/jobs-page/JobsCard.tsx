        ...
        >
          ...
          >
            ...
            >
              ...
              <Typography sx={{ fontWeight: 600, fontSize: "1rem" }} variant="caption">
                {job.company}
              </Typography>
            </Box>
            {job.url === null ? (
              ...
              <Button sx={{ color: theme.palette.mode }} variant="contained">
                {job.url && (
                  <Link href={job.url} target="_blank" rel="noopener" className="noDeco whiteColor">
                    Apply
                  </Link>
                )}
              </Button>
          ...
          >
            ...
            >
              {" "}
              <span className="boldText">Field:</span> {job.field?.replace("_", " ")}
            </Typography>
            <Typography
              variant="subtitle2"
              sx={{
            ...
            >
              ...
              {date === postedDate ? (
                <div>
                  ...
                  {getNumberOfDays(date)} {getNumberOfDays(date) > 1 ? "days" : "day"} ago
                </div>
              ) : (
                <div>
                  {" "}
                  <span className="boldText">Posted:</span>&nbsp; {postedDate} <br />
            ...
            <div className="jobDescription">
              {job.description && job.description?.length > 850 ? (
                <div>
                  ...
                  {job.url ? (
                    <Link href={job.url} target="_blank" rel="noopener" className="noDeco">
                      ... see more
                    </Link>
                  ) : (
                    ""
