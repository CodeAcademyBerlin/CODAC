    ...
    <>
      ...
      >
        ...
        <Typography variant="body1" sx={{ textAlign: "center" }}>
          Welcome to Code Academys own collection of Coding Challenges This is a page where you can
          view and add coding challenges aswell as getting hints into how to solve them
        </Typography>
        <Box
          sx={{
            display: "flex",
