...
function LmsSearchBar() {
  ...
  return (
    <>
      ...
      <div>
        <SearchInput setState={setKeywordArray} />
        <div className={styles.searchButton} onClick={goToResults}>
          <Image src={"/icons/search.png"} alt="search" width={20} height={20} />
        </div>
        {keywordArray.length > 0 && (
          <Keywords keywordArray={keywordArray} setKeywordArray={setKeywordArray} />
        )}
        <div>
          <input
            type="radio"
          ...
          <input
            ...
            value="data"
            onChange={radioHandler}
            checked={filter === "data" ? true : false}
          />
          Data
          <input
            type="radio"
            ...
            value="career"
            onChange={radioHandler}
            checked={filter === "career" ? true : false}
          />
          Career
        </div>
      </div>
