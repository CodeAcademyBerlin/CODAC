...
export default function Password({ type }: Props) {
  ...
  const submit = () => {
    ...
    if (!password.match(regex)) {
      setError(
        "The password should be at least eight characters and contain 1 Uppercase, 1 Lowercase, 1 Digit and 1 Symbol."
      );
    }
  ...
  return (
    <div style={{ textAlign: "center" }}>
      ...
      <TextField type="text" id="password" autoFocus value={password} onChange={changeHandler} />
      <br />
      <br />
