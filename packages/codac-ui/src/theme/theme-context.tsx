...
export const ThemeProvider = (props: JSX.IntrinsicAttributes & ThemeProviderProps) => {
...
const Theme: React.FC<ThemeProviderProps> = ({
  ...
  defaultTheme = enableSystem ? getSystemTheme() : "dark",
  attribute = "class",
  value,
  children,
  nonce,
  ...
  const [resolvedTheme, setResolvedTheme] = useState<string>(getTheme(storageKey) ?? defaultTheme);
