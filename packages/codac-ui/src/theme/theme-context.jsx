...
import React, { createContext, Fragment, memo, useCallback, useContext, useEffect, useMemo, useState, } from "react";
...
const Theme = ({ forcedTheme, disableTransitionOnChange = false, enableSystem = false, enableColorScheme = false, storageKey = "theme", themes = defaultThemes, defaultTheme = enableSystem ? getSystemTheme() : "dark", attribute = "class", value, children, nonce, }) => {
    const [theme, setThemeState] = useState(defaultTheme);
    const [resolvedTheme, setResolvedTheme] = useState(getTheme(storageKey) ?? defaultTheme);
