...
export const SkeletonCard = ({ isLoading = true }) => (<div className={clsx("rounded-2xl bg-gray-900/80 p-4", {
...
export const SkeletonCards = ({ isLoading = true, number, }) => (<div className="grid grid-cols-4 gap-6">
    {Array.from({ length: number }).map((_, index) => (<SkeletonCard key={index} isLoading={isLoading}/>))}
  </div>);
