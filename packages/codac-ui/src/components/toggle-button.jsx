"use client";
export function ToggleButton({ label, checked, toggle, }) {
    return (<label className="relative mr-5 inline-flex cursor-pointer items-center">
      <input type="checkbox" onChange={toggle} value="" className="peer sr-only" checked={checked}/>
