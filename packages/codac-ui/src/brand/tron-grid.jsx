...
export const TronGrid = ({ animateRerendering = true, color = "default", }) => {
    return (<div className="perspective-o-50-50 perspective-180 absolute -z-10 h-full w-full">
      <div className={clsx("rotate-x-80 absolute bottom-[-35%] left-[-50%] h-[130%] w-[200%]   bg-[length:100px_100px] bg-[-1px_-1px]", {
