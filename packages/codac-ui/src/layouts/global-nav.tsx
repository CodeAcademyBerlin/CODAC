...
export function GlobalNav({
  ...
  return (
    <div className="absolute top-0 z-10 flex w-full flex-col border-b border-gray-800 bg-gray-200 dark:bg-black  lg:bottom-0 lg:z-auto lg:w-72 lg:border-b-0 lg:border-r lg:border-gray-800">
