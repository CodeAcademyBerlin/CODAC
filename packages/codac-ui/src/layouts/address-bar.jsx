...
function Params() {
    ...
    return searchParams.toString().length !== 0 ? (<div className="px-2 text-gray-500">
      <span>?</span>
...
export function AddressBar() {
    ...
    return (<div className="flex items-center gap-x-2 p-3.5 lg:px-5 lg:py-3">
      ...
      <div className="flex gap-x-1 text-sm font-medium">
        ...
        {pathname ? (<>
            ...
            {segments.map((segment) => {
                return (<Link href={`/${segments.slice(0, segments.indexOf(segment) + 1).join("/")}`} key={segment}>
                  <span>
