...
export function DashboardLayout({ children, navigation, }) {
    return (<>
      <NextTopLoader color="#FF0080" initialPosition={0.08} crawlSpeed={200} height={3} crawl={true} showSpinner={true} easing="ease" speed={200} shadow="0 0 10px #2299DD,0 0 5px #2299DD"/>
      {navigation}
