...
export type GenericMorph =
  ...
  | ComponentHolidaysHoliday
  | ComponentHoursHours
  | ComponentKanbanBoard
  | ComponentKanbanCard
  | ComponentKanbanColumn
  | ComponentLeadLifecycle
  | ComponentLmsObjectives
  | ComponentLmsSprints
  | ComponentLmsTags
  ...
  | ComponentStudentTimeOff
  | ComponentUserProgress
  | ComponentUserProjects
  | Conversation
  | Course
...
export type GetCourseProjectQuery = {
  __typename?: "Query";
  courses?: {
    __typename?: "CourseEntityResponseCollection";
    data: Array<{
...
export type GetCourseProjectsQuery = {
  __typename?: "Query";
  courses?: {
    __typename?: "CourseEntityResponseCollection";
    data: Array<{
